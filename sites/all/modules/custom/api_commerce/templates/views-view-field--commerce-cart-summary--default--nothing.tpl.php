...
?>
<?php
	if (!empty($row->_field_data['commerce_line_item_field_data_commerce_line_items_line_item_']['entity'])) {
		print '<label class="table-label">' . $field->options['label'] . ':</label>';
		$line_item_entity = $row->_field_data['commerce_line_item_field_data_commerce_line_items_line_item_']['entity'];
